...
1. Buyer posts intent → **manifest on Walrus** + target **spec hash on Hedera** → locks payment in the live C2 Hedera EVM demo.
2. Worker agent **accepts the spec** in the live C2 flow. Gasless/zero-HBAR worker is still stretch.
...
| Beat | Needs |
|---|---|
| 1 lock + spec | E1 shipped; C1/C2 live Hedera testnet tx hashes recorded |
